                            ...
                            jobs.map((job) => (
                                <tr key={job.id} className="hover:bg-[var(--glass-bg)] transition-colors">
                                    <td className="px-6 py-4">
                                        <Link href={`/jobs/${job.id}`} className="font-semibold text-base hover:text-[var(--primary)] transition-colors inline-flex items-center gap-2">
                                            {job.title}
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="px-2.5 py-1 rounded-full text-xs font-medium border border-black/5 dark:border-white/10 bg-black/5 dark:bg-white/10 text-[var(--text-main)] dark:text-[var(--primary)]">
                                            {job.jobCategory}
                                        </span>
                                    </td>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <Link href={`/company/post-job?jobId=${job.id}`}>
